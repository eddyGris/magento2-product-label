...
class Product extends AbstractProduct
{
     ...
     * @return void
     */
    protected function _restoreOldAttrValue(AbstractModel $model, mixed $oldAttrValue): void
    {
        $attrCode = $this->getAttribute();
        if ($oldAttrValue === null) {
     ...
     * @return mixed
     */
    protected function _prepareDatetimeValue(mixed $value, AbstractModel $model)
    {
     ...
     * @return mixed
     */
    protected function _prepareMultiselectValue(mixed $value, AbstractModel $model): mixed
    {
        $attribute = $model->getResource()->getAttribute($this->getAttribute());
